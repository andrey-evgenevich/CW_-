...
def test_load_operations_json_file():
    ...
    assert load_operations(OPERATIONS_PATH) == [
        {'id': 441945886, 'state': 'EXECUTED', 'date': '2019-08-26T10:50:58.294041',
         'operationAmount': {'amount': '31957.58', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Перевод организации', 'from': 'Maestro 1596837868705199', 'to': 'Счет 64686473678894779589'},
        {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364',
        ...
        {'id': 518707726, 'state': 'EXECUTED', 'date': '2018-11-29T07:18:23.941293',
        ...
        {'id': 649467725, 'state': 'EXECUTED', 'date': '2018-04-14T19:35:28.978265',
         ...
         'description': 'Перевод организации', 'from': 'Счет 27248529432547658655', 'to': 'Счет 97584898735659638967'},
        {'id': 782295999, 'state': 'EXECUTED', 'date': '2019-09-11T17:30:34.445824',
        ...
        {'id': 542678139, 'state': 'EXECUTED', 'date': '2018-10-14T22:27:25.205631',
         ...
         'description': 'Перевод организации', 'from': 'Visa Platinum 2256483756542539',
        ...
        {'id': 407169720, 'state': 'EXECUTED', 'date': '2018-02-03T14:52:08.093722',
         ...
         'to': 'Maestro 3806652527413662'}, {'id': 361044570, 'state': 'EXECUTED', 'date': '2018-03-02T02:03:11.563721',
                                             'operationAmount': {'amount': '7484.91',
                                                                 'currency': {'name': 'USD', 'code': 'USD'}},
                                             'description': 'Перевод организации', 'from': 'Счет 96008924215040031147',
        ...
        {'id': 476991061, 'state': 'CANCELED', 'date': '2018-11-23T17:47:33.127140',
         ...
         'to': 'Maestro 3364923093037194'}, {'id': 633268359, 'state': 'EXECUTED', 'date': '2019-07-12T08:11:47.735774',
                                             'operationAmount': {'amount': '2631.44',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод организации', 'from': 'Visa Gold 3589276410671603',
                                             'to': 'Счет 96292138399386853355'},
        {'id': 988276204, 'state': 'EXECUTED', 'date': '2018-02-22T00:40:19.984219',
         'operationAmount': {'amount': '71771.90', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод организации', 'from': 'MasterCard 4956649687637418',
        ...
        {'id': 634356296, 'state': 'EXECUTED', 'date': '2018-01-21T01:10:28.317704',
         ...
         'to': 'Счет 79619011266276091215'}, {'id': 34148726, 'state': 'EXECUTED', 'date': '2018-11-23T23:52:36.999661',
                                              'operationAmount': {'amount': '79428.73',
                                                                  'currency': {'name': 'USD', 'code': 'USD'}},
        ...
        {'id': 550607912, 'state': 'EXECUTED', 'date': '2018-07-31T12:25:32.579413',
         ...
         'description': 'Перевод организации', 'from': 'MasterCard 8532498887072395',
        ...
        {'id': 484201274, 'state': 'EXECUTED', 'date': '2019-04-11T23:10:21.514616',
         'operationAmount': {'amount': '62621.51', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Перевод с карты на карту', 'from': 'МИР 8193813157568899', 'to': 'МИР 9425591958944146'},
        {'id': 547682597, 'state': 'EXECUTED', 'date': '2018-12-29T21:45:18.495053',
         'operationAmount': {'amount': '66263.93', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Перевод организации', 'from': 'Счет 77977573135347241529', 'to': 'Счет 33062909508148771891'},
        {'id': 811920303, 'state': 'EXECUTED', 'date': '2019-06-14T19:37:49.044089',
         'operationAmount': {'amount': '63150.74', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод со счета на счет', 'from': 'Счет 73222753239048295679',
        ...
        {'id': 122284694, 'state': 'EXECUTED', 'date': '2019-08-08T21:58:06.688541',
         ...
         'description': 'Перевод организации', 'from': 'Счет 99668626339273709694', 'to': 'Счет 27219929444683698245'},
        ...
        {'id': 743628025, 'state': 'EXECUTED', 'date': '2018-06-04T06:59:55.424356',
         'operationAmount': {'amount': '978.31', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод организации', 'from': 'Счет 54883981902864782073', 'to': 'Счет 61834060137088759145'},
        {'id': 743278119, 'state': 'EXECUTED', 'date': '2018-10-15T08:05:34.061711',
         'operationAmount': {'amount': '51203.12', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод с карты на карту', 'from': 'MasterCard 1435442169918409',
         'to': 'Maestro 7452400219469235'}, {'id': 871921546, 'state': 'EXECUTED', 'date': '2019-02-14T03:09:23.006652',
                                             'operationAmount': {'amount': '47022.09',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод организации',
                                             'from': 'Visa Classic 6216537926639975',
                                             'to': 'Счет 67667879435628279708'},
        {'id': 373912477, 'state': 'EXECUTED', 'date': '2018-03-09T02:11:01.339352',
         'operationAmount': {'amount': '33249.01', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Перевод с карты на счет', 'from': 'Visa Classic 7022985698476865',
         'to': 'Счет 60979028617970883410'},
        {'id': 720751477, 'state': 'EXECUTED', 'date': '2018-11-08T08:21:45.902633',
         'operationAmount': {'amount': '16872.46', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод организации', 'from': 'Счет 75743795418434298755', 'to': 'Счет 80785963509390811744'},
        {'id': 949194534, 'state': 'EXECUTED', 'date': '2019-08-15T01:48:10.042554',
         'operationAmount': {'amount': '31222.43', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Перевод организации', 'from': 'Счет 65298957349197687907', 'to': 'Счет 38784565940893479418'},
        ...
        {'id': 72122709, 'state': 'EXECUTED', 'date': '2018-12-18T17:07:09.800800',
         ...
         'description': 'Перевод со счета на счет', 'from': 'Счет 86675623828180311969',
         'to': 'Счет 15351391408911677994'},
        {'id': 242885401, 'state': 'EXECUTED', 'date': '2019-07-08T00:08:32.986663',
         'operationAmount': {'amount': '10083.68', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод со счета на счет', 'from': 'Счет 38427597486442637521',
         'to': 'Счет 83889757415570699323'},
        {'id': 286706711, 'state': 'EXECUTED', 'date': '2018-02-06T06:42:02.219233',
         'operationAmount': {'amount': '621.37', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Перевод организации', 'from': 'MasterCard 9175985085449563',
         'to': 'Счет 82781399328834147668'},
        {'id': 108066781, 'state': 'EXECUTED', 'date': '2019-06-21T12:34:06.351022',
         'operationAmount': {'amount': '25762.92', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Открытие вклада', 'to': 'Счет 90817634362091276762'},
        {'id': 100392079, 'state': 'EXECUTED', 'date': '2019-03-03T03:13:18.622393',
         'operationAmount': {'amount': '44493.45', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод с карты на счет', 'from': 'Visa Classic 6319351940209800',
         'to': 'Счет 14073196441261107791'}, {'id': 51314762, 'state': 'EXECUTED', 'date': '2018-08-25T02:58:18.764678',
                                              'operationAmount': {'amount': '52245.30',
                                                                  'currency': {'name': 'USD', 'code': 'USD'}},
                                              'description': 'Перевод с карты на карту',
        ...
        {'id': 894961746, 'state': 'EXECUTED', 'date': '2019-08-04T20:17:25.443322',
         ...
         'description': 'Перевод со счета на счет', 'from': 'Счет 33721541831646393763',
        ...
        {'id': 285353808, 'state': 'EXECUTED', 'date': '2018-08-06T16:22:54.643491',
        ...
        {'id': 556488059, 'state': 'CANCELED', 'date': '2019-05-17T01:50:00.166954',
         ...
         'description': 'Перевод с карты на карту', 'from': 'МИР 8021883699486544', 'to': 'Visa Gold 8702717057933248'},
        ...
        {'id': 636137913, 'state': 'EXECUTED', 'date': '2019-06-16T22:17:01.825020',
         'operationAmount': {'amount': '24260.78', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод с карты на счет', 'from': 'Visa Platinum 8990850370884895',
         'to': 'Счет 15574304810835774010'},
        {'id': 813238385, 'state': 'EXECUTED', 'date': '2018-05-04T03:29:30.253483',
         'operationAmount': {'amount': '22007.02', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод с карты на счет', 'from': 'MasterCard 3595832182277400',
        ...
        {'id': 854048120, 'state': 'EXECUTED', 'date': '2019-03-29T10:57:20.635567',
         ...
         'description': 'Перевод с карты на счет', 'from': 'Visa Classic 1203921041964079',
        ...
        {'id': 269462132, 'state': 'EXECUTED', 'date': '2018-08-14T05:42:30.104666',
         ...
         'description': 'Перевод со счета на счет', 'from': 'Счет 18125798580985711166',
        ...
        {'id': 431131847, 'state': 'EXECUTED', 'date': '2018-05-05T01:38:56.538074',
         ...
         'description': 'Перевод с карты на счет', 'from': 'MasterCard 9454780748494532',
         'to': 'Счет 51958934737718181351'}, {'id': 15948212, 'state': 'EXECUTED', 'date': '2018-12-23T11:47:52.403285',
                                              'operationAmount': {'amount': '47408.20',
                                                                  'currency': {'name': 'USD', 'code': 'USD'}},
                                              'description': 'Перевод с карты на карту', 'from': 'МИР 8665240839126074',
        ...
        {'id': 414894334, 'state': 'EXECUTED', 'date': '2019-06-30T15:11:53.136004',
         ...
         'description': 'Перевод со счета на счет', 'from': 'Счет 59956820797131895975',
        ...
        {'id': 509552992, 'state': 'EXECUTED', 'date': '2019-04-19T12:02:30.129240',
         ...
         'description': 'Перевод с карты на карту', 'from': 'Maestro 9171987821259925', 'to': 'МИР 2052809263194182'},
        ...
        {'id': 879660146, 'state': 'EXECUTED', 'date': '2018-07-22T07:42:32.953324',
         ...
         'description': 'Перевод организации', 'from': 'Счет 19628854383215954147', 'to': 'Счет 90887717138446397473'},
        ...
        {'id': 710136990, 'state': 'CANCELED', 'date': '2018-08-17T03:57:28.607101',
         ...
         'description': 'Перевод организации', 'from': 'Maestro 1913883747791351', 'to': 'Счет 11492155674319392427'},
        {'id': 390558607, 'state': 'EXECUTED', 'date': '2019-02-12T00:08:07.524972',
         'operationAmount': {'amount': '16796.95', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод организации', 'from': 'Счет 72645194281643232984', 'to': 'Счет 95782287258966264115'},
        {'id': 902831954, 'state': 'EXECUTED', 'date': '2018-04-22T17:01:46.885252',
         ...
         'to': 'Счет 46878338893256147528'}, {'id': 86608620, 'state': 'EXECUTED', 'date': '2019-08-16T04:23:41.621065',
                                              'operationAmount': {'amount': '6004.00',
                                                                  'currency': {'name': 'руб.', 'code': 'RUB'}},
                                              'description': 'Перевод с карты на счет',
                                              'from': 'MasterCard 8826230888662405', 'to': 'Счет 96119739109420349721'},
        {'id': 232222017, 'state': 'EXECUTED', 'date': '2018-07-06T22:32:10.495465',
         ...
         'to': 'Maestro 8602249654751155'}, {'id': 280743947, 'state': 'EXECUTED', 'date': '2018-09-27T14:26:24.629306',
                                             'operationAmount': {'amount': '45653.70',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод организации', 'from': 'Счет 23177857685058835559',
        ...
        {'id': 917824439, 'state': 'EXECUTED', 'date': '2019-07-18T12:27:13.355343',
         ...
         'to': 'МИР 2956603572573342'}, {'id': 121646999, 'state': 'CANCELED', 'date': '2018-06-08T16:14:59.936274',
                                         'operationAmount': {'amount': '91121.62',
                                                             'currency': {'name': 'руб.', 'code': 'RUB'}},
        ...
        {'id': 736942989, 'state': 'EXECUTED', 'date': '2019-09-06T00:48:01.081967',
         ...
         'description': 'Перевод организации', 'from': 'Visa Gold 3654412434951162', 'to': 'Счет 59986621134048778289'},
        {'id': 580054042, 'state': 'EXECUTED', 'date': '2018-06-20T03:59:34.851630',
         'operationAmount': {'amount': '96350.51', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод с карты на счет', 'from': 'МИР 3766446452238784', 'to': 'Счет 86655182730188443980'},
        {'id': 619287771, 'state': 'EXECUTED', 'date': '2019-08-19T16:30:41.967497',
         'operationAmount': {'amount': '81150.87', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод организации', 'from': 'Счет 17691325653939384901', 'to': 'Счет 49304996510329747621'},
        {'id': 490100847, 'state': 'EXECUTED', 'date': '2018-12-22T02:02:49.564873',
         'operationAmount': {'amount': '56516.63', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод с карты на карту', 'from': 'Visa Gold 8326537236216459',
